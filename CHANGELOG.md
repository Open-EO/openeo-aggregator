...
- Fixup compatibility with new "bands" metadata in batch job results assets ([#183](https://github.com/Open-EO/openeo-aggregator/issues/183), [Open-EO/openeo-python-driver#298](https://github.com/Open-EO/openeo-python-driver/issues/298))
